#!/usr/bin/env bash
#SBATCH -J soc-Epinions1_scaling
#SBATCH -o soc-Epinions1_scaling.out
#SBATCH -e soc-Epinions1_scaling.err
#SBATCH -t 01-00:00:00   # 1 day (adjust if needed)
#SBATCH --exclusive
#SBATCH --nodes=4

# Config
INPUT="/scratch/ipopa/repro/imm_hclib/input_files/soc-Epinions1-LT.txt"
K=100
E=0.13
OUTPUT_DIR="results"
REPS=5
