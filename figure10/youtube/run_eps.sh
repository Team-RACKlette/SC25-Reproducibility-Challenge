#!/usr/bin/env bash
#SBATCH -J youtube_epscaling
#SBATCH -o youtube_epscaling.out
#SBATCH -e youtube_epscaling.err
...
# --- Config ---
rm -rf results
INPUT="/scratch/ipopa/repro/imm_hclib/input_files/com-youtube.ungraph-LT.txt"
OUTPUT_DIR="results"
